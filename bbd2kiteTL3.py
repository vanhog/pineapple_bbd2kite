...
def read_shapefile(filename):
    ...
    for k in field_name_map:
        print(k, field_name_map[k])
    ...
    for isr, sr in enumerate(shp.iterShapeRecords()):
        ...
        data.ps_mean_var[isr] = getattr(record, field_name_map["var_mean"])
...
def bin_ps_data(data, inbins=(800, 800)):
